...
from opendbc.sunnypilot.car.tesla.speed_profile import TeslaSpeedProfileInputState
...
class CarStateExt:
  def __init__(self, CP: structs.CarParams, CP_SP: structs.CarParamsSP):
    ...
    self.speed_profile_input = TeslaSpeedProfileInputState(CP)
  ...
  def get_party_parser_messages(CP: structs.CarParams) -> list[tuple[str, float]]:
    return TeslaSpeedProfileInputState.parser_messages(bool(CP.openpilotLongitudinalControl))
