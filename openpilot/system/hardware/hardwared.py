...
def hardware_thread(end_event, hw_queue) -> None:
  ...
  while not end_event.is_set():
    ...
    average_temp_c = params.get("FanControlAmbientTemperatureC", return_default=True)
    msg.deviceState.fanSpeedPercentDesired = fan_controller.update(all_comp_temp, onroad_conditions["ignition"], average_temp_c)
